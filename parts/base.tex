...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot plot table {new_graphs/graphs/6.dat};
		\end{axis}
	\end{tikzpicture}
\end{figure}
\newpage
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot plot table {new_graphs/graphs/7.dat};
		\end{axis}
	\end{tikzpicture}
\end{figure}
\newpage
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot plot table {new_graphs/graphs/xB.dat};
		\end{axis}
	\end{tikzpicture}
	\caption{$ x_B $}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot plot table {new_graphs/graphs/yB.dat};
		\end{axis}
	\end{tikzpicture}
	\caption{$ y_B $}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot plot table {new_graphs/graphs/8.dat};
		\end{axis}
	\end{tikzpicture}
\end{figure}
\newpage
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot plot table {new_graphs/graphs/9.dat};
		\end{axis}
	\end{tikzpicture}
\end{figure}
\newpage
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot plot table {new_graphs/graphs/10.dat};
		\end{axis}
	\end{tikzpicture}
		\caption{$ x_{AB} $}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot plot table {new_graphs/graphs/11.dat};
		\end{axis}
	\end{tikzpicture}
	\caption{$ y_{AB} $}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot plot table {new_graphs/graphs/12.dat};
		\end{axis}
	\end{tikzpicture}
\end{figure}
\newpage
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot plot table {new_graphs/graphs/13.dat};
		\end{axis}
	\end{tikzpicture}
\end{figure}
\newpage
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot plot table {new_graphs/graphs/14.dat};
		\end{axis}
	\end{tikzpicture}
\end{figure}
\newpage
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot plot table {new_graphs/graphs/15.dat};
		\end{axis}
	\end{tikzpicture}
\end{figure}
\newpage
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot plot table {new_graphs/graphs/16.dat};
		\end{axis}
	\end{tikzpicture}
\end{figure}
\newpage
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot plot table {new_graphs/graphs/17.dat};
		\end{axis}
	\end{tikzpicture}
\end{figure}
\newpage
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot plot table {new_graphs/graphs/18.dat};
		\end{axis}
	\end{tikzpicture}
\end{figure}
\newpage
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot plot table {new_graphs/graphs/19.dat};
		\end{axis}
	\end{tikzpicture}
\end{figure}
\newpage
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot plot table {new_graphs/graphs/20.dat};
		\end{axis}
	\end{tikzpicture}
\end{figure}
\newpage
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot plot table {new_graphs/graphs/21.dat};
		\end{axis}
	\end{tikzpicture}
\end{figure}
\newpage
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot plot table {new_graphs/graphs/22.dat};
		\end{axis}
	\end{tikzpicture}
\end{figure}
\newpage	
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[	
			...
			\addplot plot table {new_graphs/graphs/25.dat};
		\end{axis}
	\end{tikzpicture}
\end{figure}